/********************************************
*    Context Free Grammar - Symplifier      *
*********************************************
* Author: Manuel Felipe Pineda              *
* site: https://github.com/pin3da/          * 
*********************************************
* Symply a CFG and parse a text with        *
* CYK algorithm.                            *
* The input must be in the follow format:   *
* a single line with a integer num_rules,   *
* indicates the number of productions       *
* the following num_rules lines             *
